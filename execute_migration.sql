-- МИГРАЦИЯ ДЛЯ РАСШИРЕНИЯ СТРУКТУРЫ TENDER_ESTIMATES
...
SELECT 'МИГРАЦИЯ ВЫПОЛНЕНА УСПЕШНО! Проверьте новые колонки в таблице tender_estimates.' as migration_status;